...
const Post = () => {
    ...
    try {
        ...
        setPosts((prevPosts) =>
            prevPosts.map((post) =>
                post._id === postId
                    ? { ...post, ...updatedPost, userId: post.userId || updatedPost.userId }
                    : post
            )
        );
    } catch (error) {
            ...
            <div style={{ marginLeft: '20px' }}>
                ...
                {posts.length > 0 ? (
                    posts.map((post) => (
                        ...
                        >
                            <p style={{ fontSize: '10px', color: '#007BFF', cursor: 'pointer' }}>
                            ...
                            <div className='likes' style={{ display: 'flex', gap: 20 }}>
                                <small>{post?.likes?.length} Like{post?.likes?.length !== 1 && 's'}</small>
